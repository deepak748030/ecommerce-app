...
import { ShoppingCart, CheckCircle, AlertCircle, Info } from 'lucide-react-native';

type ModalType = 'cart' | 'success' | 'error' | 'info';
...
export function ActionModal({
    ...
    const getIcon = () => {
        switch (type) {
            case 'cart':
                return <ShoppingCart size={28} color={colors.primary} />;
            case 'success':
